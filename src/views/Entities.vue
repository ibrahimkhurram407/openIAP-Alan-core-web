  ...
  <div class="card">
    <div class="row">
      <div class="col">
        <select v-model="collectionname">
          ...
          <option v-for="name in collections" :value="name" :key="name">
            {{ name }}
          </option>
        </select>
      </div>
    ...
    <div class="row">
      <div class="col">
        ...
        <button class="hidden" @click="SelectAll" v-shortkey.propagte="['ctrl', 'a']"
          @shortkey="SelectAll">SelectAll</button>
      </div>
    </div>
  </div>
  ...
  watch: {
    ...
    collectionname: async function (val, oldVal) {
      if (!Util.IsNullEmpty(val) == true && oldVal != val) {
        ...
        this.$router.push({ name: 'EntitiesCollection', params: { propcollectionname: val } });
        this.itemsSelected = [];
  ...
  methods: {
    ...
    async GetData() {
      ...
      try {
        ...
        if (this.collectionname == "workitems") {
        ...
        } else if (this.collectionname == "audit") {
          this.headers = [
            { text: "", value: "fa" },
            { text: "Name", value: "name" },
          ...
          if (this.serverOptions.sortBy == "" || this.serverOptions.sortBy == null) {
            this.serverOptions.sortBy = await this.PageStateGet({ key: "entities_" + this.collectionname + "_sortby", defaultvalue: "metadata._created" });
          }
        } else if (this.collectionname == "dbusage") {
          this.headers = [
            { text: "Name", value: "name" },
          ...
          if (this.serverOptions.sortBy == "" || this.serverOptions.sortBy == null) {
            this.serverOptions.sortBy = await this.PageStateGet({ key: "entities_" + this.collectionname + "_sortby", defaultvalue: "timestamp" });
          }
        } else if (this.collectionname == "cvr") {
          this.headers = [
            { text: "Name", value: "name" },
            { text: "Form", value: "virksomhedsformkort" },
            { text: "Opdateret", value: "sidstOpdateret", sortable: true },
            { text: "Stiftet", value: "stiftelsesDato", sortable: true },
            { text: "Ophørt", value: "ophoersDato", sortable: true },
            { text: "Levetid", value: "levetid", sortable: true },
            { text: "Status", value: "cvrstatus", sortable: true },
            { text: "Operation", value: "operation" },
          ]
          if (this.serverOptions.sortBy == "" || this.serverOptions.sortBy == null) {
            this.serverOptions.sortBy = await this.PageStateGet({ key: "entities_" + this.collectionname + "_sortby", defaultvalue: "sidstOpdateret" });
          }
        } else if (this.collectionname == "mailevents") {
          this.headers = [
            { text: "Type", value: "_type", sortable: true },
            ...
            // { text: "By", value: "metadata._createdby", sortable: true },
        ...
        } else if (this.collectionname == "mailconfig") {
          this.headers = [
            { text: "Name", value: "name", sortable: true },
            { text: "Domains", value: "domains", sortable: true },
            { text: "Emails", value: "emails", sortable: true },
            { text: "Trust", value: "auto_trust_firsttime_notspam", sortable: true },
            { text: "Deny", value: "auto_deny_firsttime_spammers", sortable: true },
            { text: "Quarantine", value: "quarantine", sortable: true },
            { text: "Modified", value: "_modified", sortable: true },
            { text: "Created", value: "_created", sortable: true },
            { text: "Operation", value: "operation" },
          ]
        ...
        } else if (this.collectionname == "maildomains") {
          this.headers = [
            { text: "Type", value: "_type", sortable: true },
            { text: "Domain", value: "domain", sortable: true },
